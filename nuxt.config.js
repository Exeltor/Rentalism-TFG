...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'Tu centro de alquiler' }
    ],
    link: [
  ...
  build: {
    transpile: ['vue-instantsearch', 'instantsearch.js/es', /^vue2-google-maps($|\/)/, 'vue-signature', 'vue-qrcode'],
  },
}
